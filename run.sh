...
python3 main.py --knn-k 5 --dr-algorithm lle --lle-k 10 --target-dim 300 --test-split dev --predictions-file lle-knn-preds.txt
python3 accuracy.py --labeled data/labels-mnist-dev.npy --predicted lle-knn-preds.txt